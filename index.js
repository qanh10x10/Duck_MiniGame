...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/Duck_MiniGame.loader.js";
var config = {
    dataUrl: buildUrl + "/Duck_MiniGame.data",
    frameworkUrl: buildUrl + "/Duck_MiniGame.framework.js",
    codeUrl: buildUrl + "/Duck_MiniGame.wasm",
